...
function SummarySection({ data, date, team, onTouchStart, onTouchEnd }) {
  ...
  const themes = [
    ...
    { name: '공공행정 & 의료', keywords: ['정부24', '손목닥터', '9988', '홈택스', '주민등록', '증명서', '민원', '국세청', '보조금', '복지로', 'PASS', '패스', '모바일신분증', '병원', '약국', '건강', '만보기', '혈압', '진료', '똑닥', '예방'], icon: '🏥', color: 'bg-teal-50 text-teal-700 border-teal-100', baseInsight: '공공 서비스 앱과 의료/건강 관리 앱 교육이 진행되어, 생활에 필수적인 디지털 행정 및 건강 관리 역량이 강화되었습니다.' }
  ];
